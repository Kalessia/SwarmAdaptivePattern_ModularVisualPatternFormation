...
def plot_sliding_puzzle_incremental_learning_density_fluidity(experiences_dir_to_plot):
    ...
    sns.heatmap(data, annot=False, annot_kws={"size": 9}, fmt=".3f", cmap="Blues", cbar=True, linewidths=0.5, linecolor='white', vmin=0.0, vmax=max_fitnesses) # annot=True to show fit values on cells
...
experiences_dir_to_plot = "simulationAnalysis/sliding_puzzle_direct_learning_two-bands_16x16"
