...
def plot_all_runs_flag_fitnesses():
    ...
    swarm_rollout_path = "/home/loi/flagAutomata/data_plots/ANTS/centered-half-discs_16x16_models-A-C-D-GECCO/sliding_puzzle_coordinates_2025-05-22_14-07-36_centered-half-discs_16x16/learning_coordinates_centered-half-discs_16x16_modelA_4-[]-3_2-[5,5]-1_swarm_rollout_2025-11-02_23-52-47"
    ...
    for best_ind in best_inds:
        ...
        for run_dir in run_dirs:
            ...
            data_flag_dir = os.path.join(run_path, best_ind, "data", "data_env0_flag")
        ...
        plt.savefig(f"{swarm_rollout_path}/plots_all_runs/flag_fitnesses_{best_ind}.png")
        plt.clf()
        plt.close()
