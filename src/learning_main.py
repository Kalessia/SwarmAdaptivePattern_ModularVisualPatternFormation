...
if (__name__ == "__main__"):
    ...
    for i, ann in enumerate(learning_params['env']['eval_function_params']['controller']):
        ann.plot_neural_network(env_name=f"ann{i+1}", analysis_dir=learning_params['analysis_dir']['root']+"/plots_all_runs")
