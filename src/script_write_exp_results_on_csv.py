...
dirs = os.listdir("simulationAnalysis")
...
for i in range(len(simulationAnalysis_dirs)):
    ...
    with open("simulationAnalysis/"+ simulationAnalysis_dirs[i] +"/learning/learning_params.json", "r") as f:
        params = json.load(f)
    
    d1 = pd.read_csv("simulationAnalysis/"+ simulationAnalysis_dirs[i] + "/learning/data_all_runs/data_evo_all_runs_best_ind_per_run.csv")
    ...
    t = None
    if os.path.exists("simulationAnalysis/"+ simulationAnalysis_dirs[i] + "/learning/data_all_runs/data_evo_all_runs_time.csv"):
        d3 = pd.read_csv("simulationAnalysis/"+ simulationAnalysis_dirs[i] + "/learning/data_all_runs/data_evo_all_runs_time.csv")
